...
#GIVING TWO OR MORE INPUTS USING A SINGLE INPUT FUNCTION
name,age = input("ENTER YOUR NAME AND AGE ").split()
#WHILE WE GIVE NAME AND AGE THEN AFTER GIVING NAME WE SHOULD PRESS SPACEBAR AND THEN WE SHOULD GIVE AGE
#IF WE WANT TO PUT , INSPITE OF SPACEBAR BETWEEN NAME AND AGE WHILE INPUTTING THEN WE CAN DO THIS BY USING split(",") RATHER THAN split()
print(name)
print(age)
